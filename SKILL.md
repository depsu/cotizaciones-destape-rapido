...
- **Limpieza extra en servicios de menos de 1 semana:** cuando el servicio es por evento corto (menos de 1 semana), agregar SIEMPRE al final de las condiciones comerciales (`condiciones_extra`) la línea: "Cada limpieza extra durante el evento tiene un costo de $20.000 neto." No aplica a arriendos mensuales (que ya incluyen aseo semanal).
